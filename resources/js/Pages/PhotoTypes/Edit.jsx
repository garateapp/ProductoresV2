...
const Edit = ({ photoType }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    put(route('photo-types.update', photoType.id));
  };
  ...
  return (
    <>
      <Card>
        <CardHeader>
          <CardTitle>Editar Tipo de Foto</CardTitle>
        </CardHeader>
        <CardContent>
...
Edit.layout = (page) => (
  <AuthenticatedLayout
    ...
    header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Editar Tipo de Foto</h2>}
  >
    {page}
  </AuthenticatedLayout>
);
